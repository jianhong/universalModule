...
module_file = loadModule('samtools_sort_index', 'master')
include { SAMTOOLS_SORT_INDEX } from "${module_file}"

workflow TEST_SAMTOOLS_SORT_INDEX {
  SAMTOOLS_SORT_INDEX(input)
}
